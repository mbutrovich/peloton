...
//                         Peloton
//
// parallel_aggregation_test.cpp
//
// Identification: test/codegen/parallel_aggregation_test.cpp
//
...
class ParallelAggregationTest : public PelotonTest {
 public:
...
TEST_F(ParallelAggregationTest, CanInsertKeyValuePairs) {
Value v = {3, 4, 5, 6};
...
TEST_F(ParallelAggregationTest, CanIterate) {
Value v = {3, 4, 5, 6};
...
TEST_F(ParallelAggregationTest, CanCodegenProbeOrInsert) {}

TEST_F(ParallelAggregationTest, MicroBenchmark) {
