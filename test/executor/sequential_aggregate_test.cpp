...
TEST_F(SequentialAggregateTests, SortedDistinctTest) {
...
TEST_F(SequentialAggregateTests, SortedSumGroupByTest) {
...
TEST_F(SequentialAggregateTests, SortedSumMaxGroupByTest) {
...
TEST_F(SequentialAggregateTests, MinMaxTest) {
...
TEST_F(SequentialAggregateTests, HashDistinctTest) {
  // SELECT d, a, b, c FROM table GROUP BY a, b, c, d;
  const int tuple_count = TESTS_TUPLES_PER_TILEGROUP;
...
TEST_F(SequentialAggregateTests, HashCountDistinctGroupByTest) {
...
TEST_F(SequentialAggregateTests, PlainSumCountDistinctTest) {
